    ...
    games: [
      {
        ...
        levels: {
          easy: [
            ...
            { question: "Which letter comes before Z?", options: ["X", "Y", "W", "V"], answer: "Y" },
            { question: "Which letter is for 'Apple'?", options: ["B", "A", "C", "D"], answer: "A" },
            { question: "Which letter is for 'Ball'?", options: ["S", "A", "M", "B"], answer: "B" },
            { question: "Click the letter C", options: ["G", "C", "O", "Q"], answer: "C" },
            { question: "What is the first letter of 'Dog'?", options: ["G", "F", "D", "E"], answer: "D" },
            { question: "Which letter comes after M?", options: ["L", "N", "O", "P"], answer: "N" },
            { question: "Which letter looks like a circle?", options: ["U", "O", "I", "E"], answer: "O" },
            { question: "What is the first letter of 'Sun'?", options: ["C", "S", "Z", "X"], answer: "S" },
            { question: "How many letters in 'CAT'?", options: ["3", "2", "4", "1"], answer: "3" },
            { question: "Which letter is for 'Elephant'?", options: ["F", "E", "L", "H"], answer: "E" },
            { question: "Which letter comes after S?", options: ["R", "T", "U", "V"], answer: "T" },
            { question: "Which letter starts 'Bird'?", options: ["D", "B", "P", "Q"], answer: "B" },
            { question: "Which letter starts 'Fish'?", options: ["S", "F", "T", "V"], answer: "F" },
            { question: "Click the letter L", options: ["I", "L", "T", "J"], answer: "L" },
            { question: "What letter starts 'Mango'?", options: ["N", "M", "H", "W"], answer: "M" },
            { question: "Which letter comes after B?", options: ["D", "C", "E", "F"], answer: "C" },
            { question: "Which letter comes after D?", options: ["F", "E", "G", "H"], answer: "E" },
            { question: "Which letter comes after F?", options: ["H", "G", "I", "J"], answer: "G" },
            { question: "Which letter comes after H?", options: ["J", "I", "K", "L"], answer: "I" },
            { question: "Which letter starts 'Octopus'?", options: ["P", "O", "Q", "R"], answer: "O" },
            { question: "Which letter starts 'Rabbit'?", options: ["B", "R", "P", "S"], answer: "R" },
            { question: "Click the letter X", options: ["K", "X", "Y", "V"], answer: "X" },
            { question: "Click the letter P", options: ["Q", "P", "B", "R"], answer: "P" },
            { question: "What letter starts 'Zebra'?", options: ["S", "Z", "X", "Y"], answer: "Z" }
          ],
          medium: [
      ...
      },
      {
        ...
        levels: {
          easy: [
            { type: "sound-match", image: "🐶", options: ["Meow", "Woof", "Moo", "Quack"], answer: "Woof" },
            { type: "sound-match", image: "🐱", options: ["Woof", "Meow", "Hiss", "Roar"], answer: "Meow" },
            { type: "sound-match", image: "🐮", options: ["Baa", "Moo", "Oink", "Neigh"], answer: "Moo" },
            { type: "sound-match", image: "🐷", options: ["Moo", "Oink", "Quack", "Cluck"], answer: "Oink" },
            { type: "sound-match", image: "🦁", options: ["Meow", "Roar", "Squeak", "Chirp"], answer: "Roar" },
            { type: "sound-match", image: "🐤", options: ["Quack", "Tweet", "Moo", "Roar"], answer: "Tweet" },
            { type: "sound-match", image: "🐸", options: ["Buzz", "Ribbit", "Hiss", "Croak"], answer: "Ribbit" },
            { type: "sound-match", image: "🐍", options: ["Buzz", "Hiss", "Rawr", "Pop"], answer: "Hiss" },
            { type: "sound-match", image: "🐑", options: ["Moo", "Baa", "Oink", "Meow"], answer: "Baa" },
            { type: "sound-match", image: "🦆", options: ["Tweet", "Quack", "Honk", "Hoot"], answer: "Quack" },
            { type: "sound-match", image: "🐘", options: ["Roar", "Trumpet", "Squeak", "Bark"], answer: "Trumpet" },
            { type: "sound-match", image: "🐵", options: ["Moo", "Chatter", "Meow", "Roar"], answer: "Chatter" },
            { type: "sound-match", image: "🦉", options: ["Chirp", "Hoot", "Tweet", "Bark"], answer: "Hoot" },
            { type: "sound-match", image: "🐴", options: ["Moo", "Neigh", "Baa", "Oink"], answer: "Neigh" },
            { type: "sound-match", image: "🐝", options: ["Hiss", "Buzz", "Hum", "Pop"], answer: "Buzz" },
            { type: "sound-match", image: "🐺", options: ["Bark", "Howl", "Growl", "Purr"], answer: "Howl" },
            { type: "sound-match", image: "🦜", options: ["Whistle", "Squawk", "Tweet", "Chirp"], answer: "Squawk" },
            { type: "sound-match", image: "🐓", options: ["Cluck", "Cock-a-doodle-doo", "Quack", "Chip"], answer: "Cock-a-doodle-doo" },
            { type: "sound-match", image: "🐁", options: ["Purr", "Squeak", "Hiss", "Bark"], answer: "Squeak" },
            { type: "sound-match", image: "🐅", options: ["Meow", "Growl", "Moo", "Baa"], answer: "Growl" }
          ],
          medium: [
